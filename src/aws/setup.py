...
Usage:
  python -m src.aws.setup --bucket my-bucket --region us-east-1 --lambda-arn arn:aws:lambda:...
"""
...
def setup_eventbridge(rule_name: str, lambda_arn: str, region: str) -> None:
    from src.aws.eventbridge_ops import grant_invoke_permission, schedule_lambda  # noqa: PLC0415
